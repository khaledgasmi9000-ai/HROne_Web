...
class ParticipationEvenementType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            // On affiche seulement les activités liées à CET événement
            ->add('activites', EntityType::class, [
                'class' => Activite::class,
                'choice_label' => 'titre',
                'label' => '🎯 Choisissez vos activités (plusieurs choix possibles) :',
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            ...
            'activites_evenement' => [] // On passera ce tableau de choix depuis le contrôleur
        ]);
    }
}
