...
class OffreRepository extends ServiceEntityRepository
{
    ...
    public function fetchOfferForManagement(int $id): ?array
    {
        ...
        $offer['skillNames'] = $this->fetchOfferDetailLabels(
            'detail_offre_competence',
        ...
        $offer['languageNames'] = $this->fetchOfferDetailLabels(
            'detail_offre_langue',
            'Code_Type_Langue',
            'type_langue',
            'Description_Langue',
        ...
        $offer['backgroundNames'] = $this->fetchOfferDetailLabels(
            'detail_offre_background',
            'Code_Type_Background_Etude',
            'type_background_etude',
            'Description_Type_Background_Etude',
            'Code_Type_Background_Etude',
            $id
        );
    ...
    private function fetchOfferDetailLabels(
        string $detailTable,
        string $detailCodeColumn,
        string $labelTable,
        string $labelColumn,
        string $labelCodeColumn,
        int $offerId
    ): array {
        $values = $this->getConnection()->fetchFirstColumn(
            sprintf(
